...
def main():
    ...
    detpath = r'//data/datasets/DOTA/TZ/split/Task1/Task1_{:s}.txt'
    annopath = r'//data/datasets/DOTA/TZ/split/labels/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imageset = os.listdir('//data/datasets/DOTA/TZ/split/labels')
    with open('valset.txt','w') as f:
        for image in imageset:
            f.write(os.path.splitext(image)[0]+'\n')
    imagesetfile = r'valset.txt'
